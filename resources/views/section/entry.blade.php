                ...
                <div class="row">
                  <div class="col">
                        ...
                        <div class="card card-form">
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <select class="form-select" id="selectKantorSerah" @disabled(!isset($data))>
                                ...
                                @isset($data)
                                  ...
                                  <option value="20900L5" @selected($data['kodeKantor'] == '20900L5')>20900L5 - DC MEDANLABUHANDELI
                                  </option>
                                  ...
                                  <option value="20900LA" @selected($data['kodeKantor'] == '20900LA')>20900LA - DC MEDAN TIMBANGDELI
                                  </option>
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputKantorPabean"
                                name="inputKantorPabean" readonly @disabled(!isset($data))
                                @isset($data)
                          ...
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNamaPengangkut"
                                name="inputNamaPengangkut" @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNomorAngkutan"
                                name="inputNomorAngkutan" @disabled(!isset($data))
                                @isset($data)
                              ...
                              <div class="col-12 col-md-4 mb-3 mb-md-0">
                                <div class="col-border">
                                  ...
                                  <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="inputTglBC" name="inputTglBC"
                                      placeholder="yyyy-mm-dd" autocomplete="off" @disabled(!isset($data))
                                      @isset($data)
                                ...
                                <div class="col-border">
                                  <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="inputNoPOSBC" name="inputNoPOSBC"
                                      maxlength="4" @disabled(!isset($data))
                                      @isset($data)
                                  ...
                                  <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="inputNoSubPOSBC"
                                      name="inputNoSubPOSBC" maxlength="4" @disabled(!isset($data))
                                      @isset($data)
                                ...
                                <div class="col-border">
                                  <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="inputNoSub2POSBC"
                                      name="inputNoSub2POSBC" maxlength="4" @disabled(!isset($data))
                                      @isset($data)
                    ...
                    <div class="row text-center">
                      <div class="col">
                        <button type="button" class="btn btn-next btn-style" id="btnNextHeader"
                          @disabled(!isset($data))>Selanjutnya<i type="button"
                        ...
                        <div class="card card-form">
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <select class="form-select" id="selectJenisIDPemberitahu" name="selectJenisIDPemberitahu"
                                @disabled(!isset($data))>
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNoIDPemberitahu"
                                name="inputNoIDPemberitahu" @disabled(!isset($data))
                                @isset($data)
                          ...
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNoIDPenerima"
                                name="inputNoIDPenerima" @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNamaPenerima"
                                name="inputNamaPenerima" @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputAlamatPenerima"
                                name="inputAlamatPenerima" @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNoTeleponPenerima"
                                name="inputNoTeleponPenerima" @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNegaraTujuan"
                                name="inputNegaraTujuan" @disabled(!isset($data))
                                @isset($data)
                          ...
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNamaPengirim"
                                name="inputNamaPengirim" @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputAlamatPengirim"
                                name="inputAlamatPengirim" @disabled(!isset($data))
                                @isset($data)
                          ...
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputKodeMarketplace"
                                name="inputKodeMarketplace" @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNamaMarketplace"
                                name="inputNamaMarketplace" @disabled(!isset($data))
                                @isset($data)
                          ...
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNoMasterBLAWB"
                                name="inputNoMasterBLAWB" @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNoHouseBLAWB"
                                name="inputNoHouseBLAWB" @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNoKantong" name="inputNoKantong"
                                @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNoInvoice" name="inputNoInvoice"
                                @disabled(!isset($data))
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTglInvoice" name="inputTglInvoice"
                                @disabled(!isset($data))
                                @isset($data)
                  ...
                  <div class="col">
                        ...
                        <div class="card card-form">
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control form-barang" id="inputSeriBarang"
                                name="inputSeriBarang">
                            </div>
                            <div class="mb-2">
                              <label for="inputHSCODE" class="form-label">HSCODE</label>
                              <input type="text" class="form-control form-barang" id="inputHSCODE"
                                name="inputHSCODE">
                            </div>
                            <div class="mb-2">
                        ...
                        <div class="card card-form">
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputNilaiTukar" name="inputNilaiTukar"
                                @isset($data)
                                  value="{{ $data['ndpbm'] }}"
                                @endisset>
                            </div>
                        ...
                        <div class="card card-form">
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputBrutoBarang" name="inputBrutoBarang"
                                @isset($data)
                                  value="{{ $data['bruto'] }}"
                                @endisset>
                            </div>
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control form-barang" id="inputFobBarang"
                                name="inputFobBarang">
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control form-barang" id="inputCIFBarang"
                                name="inputCIFBarang">
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="card-body">
                            ...
                            <div class="mt-3 mb-3">
                              ...
                              <div class="row">
                                ...
                                <div class="col-9">
                                  <select class="form-select form-barang" id="selectJenisKemasan"
                                    name="selectJenisKemasan">
                            ...
                            <div class="mb-2">
                              ...
                              <div class="row">
                                ...
                                <div class="col-9">
                                  <select class="form-select form-barang" id="selectJenisSatuan"
                                    name="selectJenisSatuan">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control form-barang" id="inputHargaSatuan"
                                name="inputHargaSatuan">
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="card card-form ">
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control form-barang" id="inputNomorSkep"
                                name="inputNomorSkep">
                            </div>
                            <div class="mb-2">
                              <label for="inputTglSkep" class="form-label">Tanggal Skep</label>
                              <input type="text" class="form-control form-barang" id="inputTglSkep"
                                name="inputTglSkep">
                            </div>
                            <div class="mb-2">
                              <label for="inputImei1" class="form-label">IMEI 1</label>
                              <input type="text" class="form-control form-barang" id="inputImei1"
                                name="inputImei1">
                            </div>
                            <div class="mb-2">
                              <label for="inputImei2" class="form-label">IMEI 2</label>
                              <input type="text" class="form-control form-barang" id="inputImei2"
                                name="inputImei2">
                            </div>
                          </div>
                        </div>
                              ...
                              <div class="col-12 col-md-4 mb-3 mb-lg-0">
                                <div class="col-border">
                                  ...
                                  <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control form-barang" id="inputTarifBM"
                                      name="inputTarifBM">
                                  </div>
                                  <div class="mb-2">
                                    <label for="inputNilaiBM" class="form-label">Nilai BM</label>
                                    <input type="text" class="form-control form-barang" id="inputNilaiBM"
                                      name="inputNilaiBM">
                                  </div>
                                </div>
                              </div>
                    ...
                    <div class="row justify-content-between box-style py-2">
                      ...
                      <div class="col-3 text-end">
                        <button style="display: none;" type="button" class="btn btn-outline-secondary" id="btn-cancel-edit">
                          <i class="bi bi-x-circle-fill me-2"></i>Cancel Edit
                        </button>
                      </div>
                      <div class="col-3 text-start">
                        <button style="display: none;" type="button" class="btn btn-outline-success" id="btn-save-item">
                        <i class="bi bi-save-fill me-2"></i>Save Item
                      </button>
                    </div>
                    <div class="col-3 text-end">
                        <button type="button" class="btn" id="btn-add">
                          <i class="bi bi-plus-square-fill me-2"></i>Add Item
                        </button>
                      </div>
                    </div>
                    <div class="row">
                              ...
                              @isset($data)
                                ...
                                @foreach ($data['barang'] as $data_barang)
                                  <tr>
                                    ...
                                    <td><button type="button" class="btn btn-sm btn-outline-secondary btn-edit"
                                        data-id="">Edit</button></td>
                                    <td>{{ $x++ }}</td>
                        ...
                        <div class="card card-form">
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalFobBarang"
                                name="inputTotalFobBarang" disabled readonly
                                @isset($data)
                                  value="{{ $data['fobTotal'] }}"
                                @endisset>
                            </div>
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalAsuransiBarang"
                                name="inputTotalAsuransiBarang" disabled readonly
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalNettoBarang"
                                name="inputTotalNettoBarang" disabled readonly
                                @isset($data)
                                  value="{{ $data['netto'] }}"
                                @endisset>
                            </div>
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalFreightBarang"
                                name="inputTotalFreightBarang" disabled readonly
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalCIFBarang"
                                name="inputTotalCIFBarang" disabled readonly
                                @isset($data)
                                  value="{{ $data['cifTotal'] }}"
                                @endisset>
                            </div>
                        ...
                        <div class="card card-form">
                          <div class="card-body">
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalBm" name="inputTotalBm"
                                disabled readonly
                                @isset($data)
                                  value="{{ $data['totalBm'] }}"
                                @endisset>
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalBmad" name="inputTotalBmad"
                                disabled readonly
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalBmtp" name="inputTotalBmtp"
                                disabled readonly
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalPpn" name="inputTotalPpn"
                                disabled readonly
                                @isset($data)
                                  value="{{ $data['totalPpn'] }}"
                                @endisset>
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalPpnbm"
                                name="inputTotalPpnbm" disabled readonly
                                @isset($data)
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalPph" name="inputTotalPph"
                                disabled readonly
                                @isset($data)
                                  value="{{ $data['totalPph'] }}"
                                @endisset>
                            ...
                            <div class="mb-2">
                              ...
                              <input type="text" class="form-control" id="inputTotalTagihan"
                                name="inputTotalTagihan" disabled readonly
                                @isset($data)
                      ...
                      <div class="card-body">
                        ...
                        <div class="row mb-1">
                          ...
                          <div class="col-md col-xl-6 px-3 mb-3 mb-md-0">
                            ...
                            <div class="row mb-2">
                              <label for="readNoSub2POSBC" class="col-form-label col-md-5 col-xxl-4">Nomor Sub SubPOS
                                BC
                                1.1</label>
                              <div class="col-md-7 col-xxl-8">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row mb-2">
                              ...
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                                  id="readNoIDPemberitahu" name="readNoIDPemberitahu">
                              </div>
                            </div>
                            <div class="row mb-2">
                              ...
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                                  id="readNamaPemberitahu" name="readNamaPemberitahu">
                              </div>
                            </div>
                            <div class="row mb-2">
                              ...
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                                  id="readAlamatPemberitahu" name="readAlamatPemberitahu">
                              </div>
                            </div>
                            <div class="row mb-2">
                              ...
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                                  id="readNoIzinPemberitahu" name="readNoIzinPemberitahu">
                              </div>
                            </div>
                            <div class="row mb-2">
                              <label for="readTglIzinPemberitahu" class="col-form-label col-md-5 col-xxl-4">Tanggal
                                Izin
                                Pemberitahu</label>
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                          ...
                          <div class="col-md col-xl-6 px-3 mb-3 mb-md-0">
                            ...
                            <div class="row mb-2">
                              ...
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                                  id="readNoTeleponPenerima" name="readNoTeleponPenerima">
                              </div>
                            </div>
                            <div class="row mb-2">
                        ...
                        <div class="row mb-3">
                          <div class="col-md col-xl-6 px-3 mb-3 mb-md-0">
                            ...
                            <div class="row mb-2">
                              <label for="readAsalNegara" class="col-form-label col-md-5 col-xxl-4">Asal
                                Negara</label>
                              <div class="col-md-7 col-xxl-8">
                          ...
                          <div class="col-md col-xl-6 px-3 mb-3 mb-md-0">
                            ...
                            <div class="row mb-2">
                              <label for="readNoKantong" class="col-form-label col-md-5 col-xxl-4">Nomor
                                Kantong</label>
                              <div class="col-md-7 col-xxl-8">
                            ...
                            <div class="row mb-2">
                              <label for="readNoInvoice" class="col-form-label col-md-5 col-xxl-4">Nomor
                                Invoice</label>
                              <div class="col-md-7 col-xxl-8">
                            ...
                            <div class="row mb-2">
                              <label for="readTglInvoice" class="col-form-label col-md-5 col-xxl-4">Tanggal
                                Invoice</label>
                              <div class="col-md-7 col-xxl-8">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md col-xl-6 px-3 mb-3 mb-md-0">
                            ...
                            <div class="row mb-2">
                              <label for="readKodeMarketplace" class="col-form-label col-md-5 col-xxl-4">Kode
                                Marketplace</label>
                              <div class="col-md-7 col-xxl-8">
                            ...
                            <div class="row mb-2">
                              <label for="readNamaMarketplace" class="col-form-label col-md-5 col-xxl-4">Nama
                                Marketplace</label>
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                                  id="readNamaMarketplace" name="readNamaMarketplace">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col col-md col-xl-6 px-3 mb-3 mb-md-0">
                            ...
                            <div class="row mb-2">
                              <label for="readTotalBrutoBarang" class="col-form-label col-md-5 col-xxl-4">Total Bruto
                                Barang</label>
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                                  id="readTotalBrutoBarang" name="readTotalBrutoBarang">
                              </div>
                            </div>
                            <div class="row mb-2">
                              ...
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                                  id="readTotalNettoBarang" name="readTotalNettoBarang">
                              </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                              <label for="readTotalAsuransiBarang" class="col-form-label col-md-5 col-xxl-4">Total
                                Asuransi Barang</label>
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                                  id="readTotalAsuransiBarang" name="readTotalAsuransiBarang">
                              </div>
                            </div>
                            <div class="row mb-2">
                              <label for="readTotalFreightBarang" class="col-form-label col-md-5 col-xxl-4">Total
                                Freight Barang</label>
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control"
                                  id="readTotalFreightBarang" name="readTotalFreightBarang">
                              </div>
                            </div>
                            <div class="row mb-2">
                              <label for="readTotalCIFBarang" class="col-form-label col-md-5 col-xxl-4">Total CIF
                                Barang</label>
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control" id="readTotalCIFBarang"
                                  name="readTotalCIFBarang">
                              </div>
                            </div>
                          </div>
                          <div class="col col-md col-xl-6 px-3 mb-3 mb-md-0">
                            ...
                            <div class="row mb-2">
                              ...
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly class="form-control" id="readTotalBm" name="readTotalBm">
                              </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                              <label for="readTotalPpnbm" class="col-form-label col-md-5 col-xxl-4">Total
                                PPnBM</label>
                              <div class="col-md-7 col-xxl-8">
                            ...
                            <div class="row mb-2">
                              ...
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control" id="readTotalPph"
                                  name="readTotalPph">
                              </div>
                            </div>
                            <div class="row mb-2">
                              <label for="readTotalTagihan" class="col-form-label col-md-5 col-xxl-4">Total
                                Tagihan</label>
                              <div class="col-md-7 col-xxl-8">
                                <input disabled readonly type="text" class="form-control" id="readTotalTagihan"
                                  name="readTotalTagihan">
                              </div>
                            </div>
                          </div>
                        </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      function calculateNilai() {
        ...
        console.log(fob);
        let asuransi = isNaN(parseFloat($("#inputAsuransiBarang").val())) ? 0 : parseFloat($("#inputAsuransiBarang")
          .val());
        let freight = isNaN(parseFloat($("#inputFreightBarang").val())) ? 0 : parseFloat($("#inputFreightBarang")
        .val());
      ...
      function sumDataBarang() {
        ...
        $("#table-barang tbody tr").each(function() {
          sumNetto += isNaN(parseFloat($(this).find("td:eq(7)").text())) ? 0 : parseFloat($(this).find("td:eq(7)")
            .text());
          sumFob += isNaN(parseFloat($(this).find("td:eq(8)").text())) ? 0 : parseFloat($(this).find("td:eq(8)")
            .text());
          sumAsuransi += isNaN(parseFloat($(this).find("td:eq(9)").text())) ? 0 : parseFloat($(this).find(
            "td:eq(9)").text());
          sumFreight += isNaN(parseFloat($(this).find("td:eq(10)").text())) ? 0 : parseFloat($(this).find(
            "td:eq(10)").text());
          sumCif += isNaN(parseFloat($(this).find("td:eq(11)").text())) ? 0 : parseFloat($(this).find("td:eq(11)")
            .text());
          sumBm += isNaN(parseFloat($(this).find("td:eq(23)").text())) ? 0 : parseFloat($(this).find("td:eq(23)")
            .text());
          sumBmad += isNaN(parseFloat($(this).find("td:eq(26)").text())) ? 0 : parseFloat($(this).find(
            "td:eq(26)").text());
          sumBmtp += isNaN(parseFloat($(this).find("td:eq(29)").text())) ? 0 : parseFloat($(this).find(
            "td:eq(29)").text());
          sumPpn += isNaN(parseFloat($(this).find("td:eq(31)").text())) ? 0 : parseFloat($(this).find("td:eq(31)")
            .text());
          sumPpnbm += isNaN(parseFloat($(this).find("td:eq(33)").text())) ? 0 : parseFloat($(this).find(
            "td:eq(33)").text());
          sumPph += isNaN(parseFloat($(this).find("td:eq(35)").text())) ? 0 : parseFloat($(this).find("td:eq(35)")
            .text());
        })
      ...
      function setConfirmationForm() {
        ...
        $("#readKantorSerah").val($("#selectKantorSerah option[value='" + $('#selectKantorSerah').val() + "']")
        .text());
        $("#readKantorPabean").val($('#inputKantorPabean').val());
        $("#readPelabuhanMuat").val($("#selectPelabuhanMuat option[value='" + $('#selectPelabuhanMuat').val() + "']")
          .text());
        $("#readPelabuhanBongkar").val($("#selectPelabuhanBongkar option[value='" + $('#selectPelabuhanBongkar')
        .val() + "']").text());
        $("#readGudang").val($("#selectGudang option[value='" + $('#selectGudang').val() + "']").text());
        $("#readJenisAngkutan").val($("#selectJenisAngkutan option[value='" + $('#selectJenisAngkutan').val() + "']")
          .text());
        ...
        $("#readJenisIDPemberitahu").val($("#selectJenisIDPemberitahu option[value='" + $('#selectJenisIDPemberitahu')
          .val() + "']").text());
        ...
        $("#readJenisIDPenerima").val($("#selectJenisIDPenerima option[value='" + $('#selectJenisIDPenerima').val() +
          "']").text());
      ...
      function setObject(table) {
        body = {
          ...
          "barang": table,
          "posBC11": $("input[name=inputNoPOSBC]").val() + $("input[name=inputNoSubPOSBC]").val() + $(
            "input[name=inputNoSub2POSBC]").val(),
