...
@section('contents')
                  ...
                  <div class="col">
                    ...
                    <div class="row">
                      <div class="col-md col-xl-4">
                        {{-- <x-form.card title="Detail Kantor">
                          <x-form.card-content title="Nomor Barang" name="inputNomorBarang">
                            <x-form.input id="inputNomorBarang"/>
                          </x-form.card-content>
                          <x-form.card-content title="Kantor Serah" name="selectKantorSerah">
                            <x-form.select id="selectKantorSerah">
                              <option value="10000">10000 - Jakarta Pusat</option>
                              <option value=""></option>
                              <option value=""></option>
                            </x-form.select>
                          </x-form.card-content>
                          <x-form.card-content title="Kantor Pabean" name="selectKantorPabean">
                            <x-form.input id="selectKantorPabean"/>
                          </x-form.card-content>
                        </x-form.card> --}}
                            ...
                            <div class="mb-2">
                              ...
                              <select class="form-select" id="selectKantorSerah">
                                ...
                                @isset($data)
                                  ...
                                  {{-- <option value="13000" {{ $data["kodeKantor"] == "13000" }}> 13000 - JAKARTA TIMUR</option>
                                  <option value="14000" {{ $data["kodeKantor"] == "14000" }}> 14000 - JAKARTA UTARA</option>
                                  <option value="15000" {{ $data["kodeKantor"] == "15000" }}> 15000 - TANGERANG</option>
                                  <option value="15400" {{ $data["kodeKantor"] == "15400" }}> 15400 - CIPUTAT</option>
                                  <option value="16000" {{ $data["kodeKantor"] == "16000" }}> 16000 - BOGOR</option>
                                  <option value="16400" {{ $data["kodeKantor"] == "16400" }}> 16400 - DEPOK</option>
                                  <option value="16900" {{ $data["kodeKantor"] == "16900" }}> 16900 - CIBINONG</option> --}}
                                @endisset
                              </select>
                            </div>
                            <div class="mb-2">
                              ...
                              @endisset >
                              <button type="button" class="btn btn-outline-secondary" id="btnSubmitId">Input</button>
                            </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      function getInitialJson(no_barang) {
        $.ajax({
          type: "post",
          ...
          success: function(response) {
            ...
            console.log('success');
            // getNewPage()
            window.location.replace('/entry3')
          },
